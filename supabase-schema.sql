-- ============================================================
-- SAMKO Lubricants - Blog Database Schema
...
INSERT INTO blog_categories (id, name, slug, description) VALUES
  ('cat-1', 'Industry Trends', 'industry-trends', 'Pakistan oil market updates and price analysis'),
  ('cat-2', 'Technical Guide', 'technical-guide', 'Technical guides for vehicles and machinery'),
  ('cat-3', 'Maintenance', 'maintenance', 'Practical maintenance tips for Pakistani conditions'),
  ('cat-4', 'Company News', 'company-news', 'SAMKO company updates and announcements')
ON CONFLICT (slug) DO NOTHING;

-- ============================================================
-- Seed default blog posts
-- ============================================================
INSERT INTO blog_posts (id, title, slug, excerpt, content, category, author, author_role, published_at, updated_at, read_time, image, featured, published, tags) VALUES
(
  'post-1',
  'Petrol Prices in Pakistan: What Fleet Owners Should Know in 2025',
  'petrol-prices-pakistan-fleet-owners-2025',
  'Understanding how OGRA price changes affect your transport business and practical tips to reduce fuel costs for Pakistani fleet operators.',
  '<p>Every fortnight when OGRA announces new fuel prices, transport company owners across Pakistan hold their breath. Whether you''re running a fleet of trucks on the GT Road or managing buses between Lahore and Karachi, fuel costs can make or break your business.</p>
...
<p>Got questions about fleet lubrication? Visit our Sargodha office or call us. Real advice, no sales pressure.</p>',
  ...
  true,
  true,
  ARRAY['petrol-prices', 'fleet', 'pakistan', 'transport']
),
(
  'post-2',
  'Garmi Mein Gaari Ki Care: Summer Vehicle Maintenance for Pakistan',
  'summer-vehicle-maintenance-pakistan',
  'Practical summer car care tips for Pakistani weather. From coolant checks to engine oil grades - what your local mechanic might not tell you.',
  '<p>June in Multan. The sun is ruthless. Your car''s temperature gauge is creeping up. Every Pakistani driver knows this feeling. Let''s talk about what actually works to keep your vehicle running in our extreme summers.</p>
...
<p>Stay safe on the roads. And if you need lubricants before your trip, our Sargodha showroom stays open till 9 PM on weekends during summer.</p>',
  ...
  true,
  true,
  ARRAY['summer', 'maintenance', 'car-care', 'pakistan']
),
(
  'post-3',
  'Generator Oil: The Loadshedding Season Essential Guide',
  'generator-oil-loadshedding-pakistan-guide',
  'When bijli goes, your generator kicks in. But is your genset running on the right oil? Common mistakes Pakistani households and businesses make.',
  '<p>Load shedding is a Pakistani reality. Whether you''re a textile mill in Faisalabad or a home in DHA Lahore, your generator is your lifeline. But here''s what I''ve noticed visiting customers across Punjab - almost nobody maintains their generators properly until they break down.</p>
...
<p>Need genuine generator oil? SAMKO supplies to factories, hospitals, and housing societies across Pakistan. Bulk rates available for commercial customers.</p>',
  ...
  false,
  true,
  ARRAY['generator', 'loadshedding', 'maintenance', 'industrial']
),
(
  'post-4',
  'Tractor Engine Oil Guide: What Punjab Farmers Need to Know',
  'tractor-engine-oil-punjab-farmers',
  'From wheat harvesting to tube well operation - choosing the right oil for Pakistani tractors. Massey Ferguson, Fiat, and local assemblers covered.',
  '<p>Last month I visited a farmer near Okara. His Massey 240 had been running since 1992 - still going strong. Secret? He''s religious about oil changes. "Beta, ye tractor meri rozi hai," he told me. That''s the attitude every farmer should have.</p>
...
<p>We understand farming economics. That''s why SAMKO prices are kept reasonable without compromising quality. Your tractor should last another 30 years if maintained properly.</p>',
  ...
  '2024-12-28T08:00:00Z',
  '2024-12-28T08:00:00Z',
  '6 min read',
  'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=800',
  false,
  true,
  ARRAY['tractor', 'farming', 'punjab', 'agriculture']
),
(
  'post-5',
  'Why Your Bike Mechanic Might Be Using Wrong Oil',
  'motorcycle-oil-pakistan-guide',
  'That Rs. 200 oil change at your local workshop could be destroying your motorcycle engine. Here''s what every Honda, Yamaha, and CD70 owner should know.',
  '<p>Pakistan runs on motorcycles. From the CD70 carrying a family of four to the Yamaha YBR delivering food orders, bikes are everywhere. But the oil going into these engines? That''s where problems start.</p>
...
<p>SAMKO sells genuine motorcycle oil in consumer-friendly 1-litre packs. Available at our dealers across Punjab. Your bike will thank you.</p>',
  ...
  false,
  true,
  ARRAY['motorcycle', 'bike', 'oil-change', 'maintenance']
),
(
  'post-6',
  'SAMKO Opens New Distribution Center in Faisalabad',
  'samko-faisalabad-distribution-center',
  'Expanding our reach to serve Pakistan''s textile capital better. Same day delivery now available for Faisalabad industrial area.',
  '<p>Alhamdulillah, we are pleased to announce the opening of our new distribution center in Faisalabad, strategically located in the Jhang Road industrial area.</p>
...
<p>This expansion is part of SAMKO''s commitment to serving Pakistani industry. From our roots in Sargodha, we''re growing to meet the needs of manufacturers across Punjab.</p>',
  ...
  false,
  true,
  ARRAY['company', 'expansion', 'faisalabad', 'industrial']
)
ON CONFLICT (slug) DO NOTHING;
